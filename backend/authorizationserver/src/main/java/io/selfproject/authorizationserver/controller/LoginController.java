package io.selfproject.authorizationserver.controller;

import io.selfproject.authorizationserver.exception.ApiException;
import io.selfproject.authorizationserver.model.User;
import io.selfproject.authorizationserver.security.MfaAuthentication;
...
import static io.selfproject.authorizationserver.utils.RequestUtils.getMessage;
...
//    }
    ...
    private String getAuthenticatedUser(Authentication authentication) {
        ...
        if (principal instanceof User) {
            ...
            if (innerPrincipal instanceof User) {
                return ((User) innerPrincipal).getEmail();
            }
        }
    ...
    private User getUser(Authentication authentication) {
        ...
        if (principal instanceof User) {
            ...
            Object innerPrincipal = ((UsernamePasswordAuthenticationToken) principal).getPrincipal();
            if (innerPrincipal instanceof User) {
                return (User) innerPrincipal;
            }
        }
        throw new IllegalStateException("User not found in authentication principal");
    }
