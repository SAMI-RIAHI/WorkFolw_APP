package io.selfproject.authorizationserver.query;
...
public class UserQuery {
    ...
    public static final String CHECK_DEVICE_EXIST_QUERY = """
                SELECT device_id FROM devices
                WHERE user_id = :userId AND device = :device AND client = :client AND ip_address = :ipAddress
            """;

    public static final String UPDATE_DEVICE_TIMESTAMP_QUERY = """
                UPDATE devices
