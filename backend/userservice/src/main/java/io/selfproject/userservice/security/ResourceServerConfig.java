package io.selfproject.userservice.security;

import io.selfproject.userservice.handler.CustomAccessDeniedHandler;
import io.selfproject.userservice.handler.CustomAuthenticationEntryPoint;
...
public class ResourceServerConfig {
   ...
   // @Bean
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOrigins(Arrays.asList("http://localhost:8000", "http://localhost:4200", "http://localhost:3000"));
