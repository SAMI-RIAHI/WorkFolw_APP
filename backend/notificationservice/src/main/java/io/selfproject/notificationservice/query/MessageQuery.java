package io.selfproject.notificationservice.query;
...
public class MessageQuery {
    ...
    public static final String UPDATE_MESSAGE_STATUS_QUERY =
                               """
                               UPDATE message_statuses SET message_status = :status WHERE user_id = (SELECT u.user_id FROM users u WHERE u.user_uuid = :userUuid) AND message_statuses.message_id = :messageId
                               """;
