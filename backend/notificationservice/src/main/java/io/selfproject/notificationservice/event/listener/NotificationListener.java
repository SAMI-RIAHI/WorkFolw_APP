package io.selfproject.notificationservice.event.listener;

import com.fasterxml.jackson.databind.ObjectMapper;
import io.selfproject.notificationservice.domain.Data;
import io.selfproject.notificationservice.domain.Notification;
...
public class NotificationListener {
    ...
    public void handleNotification(Notification notification) {
        ...
        switch (notification.getPayload().getEventType()) {
            case RESET_PASSWORD -> emailService.sendPasswordResetHtmlEmail(data.getName(), data.getEmail(), data.getToken());
