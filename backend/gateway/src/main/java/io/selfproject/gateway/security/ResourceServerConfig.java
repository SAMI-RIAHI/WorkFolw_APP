package io.selfproject.gateway.security;

import io.selfproject.gateway.handler.GatewayAccessDeniedHandler;
import io.selfproject.gateway.handler.GatewayAuthenticationEntryPoint;
...
public class ResourceServerConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOrigins(List.of(
                "http://192.168.1.157:3000", "http://localhost:3000", "http://192.168.1.159:3000", "http://localhost:4200",
                "http://100.14.214.212:3000", "http://192.168.1.216:3000"
        ));
